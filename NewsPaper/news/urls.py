...
from .views import PostsList, PostDetail, PostSearch, PostCreateNews, PostCreateArticle, PostsUpdateNews, PostsUpdateArticles, PostsDeleteNews, PostsDeleteArticles
